...
export const loader = async ({ request }: LoaderFunctionArgs) => {
    ...
    const dataSecretWords = {
        "start": [
            "CHAT", "MAISON", "ARBRE", "ROUGE", "VOITURE", "NOIX", "TOIT", "SEL",
            "EAU", "FLEUR", "TABLE", "FENETRE", "SOURIS", "JARDIN", "DOIGT",
            "MER", "NUIT", "JOUR", "PAIN", "LUNE", "CHAPEAU", "CHEMISE", "CLOWN",
            "RIVIERE", "PLAGE", "VILLE", "FORET", "NEIGE", "CERCLE", "TIGRE", "CLEF",
            "ROULEAU", "PIERRE", "COULEUR", "ANGLE", "ESPACE", "VOILE", "PONT",
            "LAC", "CRAYON", "ANANAS", "POIRE", "RATON", "OISEAU", "LION", "BRANCHE",
            "CANARD", "CHEVAL", "POULET", "PORC", "ROUE", "PORT", "TEMPS", "CHOU",
            "SOLEIL", "CIEL", "LIVRE", "CHIEN", "POMME", "MONT", "BATEAU", "JOUET",
            "VAGUE", "NUAGE", "SABLE", "LOUP", "GRAIN", "FEUILLE", "BOIS", "JEUX",
            "RACINE", "FRUIT", "PIED", "MAIN", "BRAS", "CERF", "RAT", "BICHE", "REINE",
            "BALLE", "PERLE", "COEUR", "VERRE", "BOITE", "MUR", "VIN", "BANC", "LUMIERE",
            "HERBE", "PAPIER", "FEU", "CUBE", "FIL", "GANT", "IMAGE", "FOYER", "DONUT", "CHOUX",
        ],
        "inter": [
            "OXYGENE", "NEURONE", "ISOTOPE", "MAGMA", "BIOPSIE", "HORIZON", "OPTIQUE",
            "CYNISME", "ECLIPSE", "CORAIL", "CULTURE", "CORTEX", "IMPULS",
            "CALCIUM", "GLACIER", "PRISME", "SPECTRE", "CABINET", "FORMULE", "FOSSILE",
            "ATOMES", "CRATERE", "ENZYME", "FUNGUS", "LARVE", "VIRUS", "CERVEAU", "BIOME",
            "NEBULE", "CHROME", "AZOTE", "BARYON", "CELLULE", "FERMENT", "MATRIX", "POLLEN",
            "GAZON", "QUARKS", "LASER", "DRONE", "GAZ", "MOULE", "PERCHOIR", "ORGUE", "ATOMIQUE",
            "SPHERE", "TURBINE", "MIXEUR", "NODULE", "LEVURE", "VACCIN", "BOLIDE", "STYLO",
            "NEURON", "MERCURE", "ZENITH", "MALADIE", "MURMURE", "AMMONIA", "RUBIS", "JAVEL",
            "GLUCIDE", "CIRCUIT",
        ],
        "difficile": [
            "SYNTAXE", "ARSENIC", "PLATINE", "URANIUM", "NEODYME", "QUASAR",
            "GALLIUM", "RHENIUM", "INDIUM", "COBALT", "CADMIUM", "PHOTON",
            "QUARK", "IODURE", "BORAX", "ZIRCON", "RADON", "OXYDE", "OZONIDE",
            "GIBBSITE", "PYRITE", "SULFATE", "FLUORE", "LYMPHE", "PLUTON",
            "CRYPTO", "GLYPHE", "RHIZOME", "GYPSE", "PLASMA", "CACTUS", "ZODIAQUE",
            "ETHYLE", "OZONE", "XYLENE", "TUNGSTEN", "NICKEL", "CRYPTE",
            "KRYPTON", "ARGON", "BORATE", "CESIUM", "BERYLL",
        ],
        "expert": [
                ...
                listWordsSecret.length === 0 ?
                    (
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="flex items-center justify-center w-full rounded-lg shadow pt-[20vh]"
                        >
